...
//         // "https://recipe-project-backend-mejp.onrender.com/process-data",
...
//           <RouterLink to="/" className="text-gray-600 mb-4 hover:text-gray-900">
//             ← Back to Home
//           </RouterLink>
...
//                           console.log(`Recipe ${index}:`, recipe); // Debugging
//                           return (
